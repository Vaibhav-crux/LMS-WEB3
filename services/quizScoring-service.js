...
// function calculateTotalChapterScore(chapterProgress) {
//   return chapterProgress.quizzesCompleted.reduce(
//     (total, quizResult) => total + quizResult.score,
//     0
//   );
// }

// function calculateTotalCourseScore(courseProgress) {
//   return courseProgress.chapters.reduce(
//     (total, chapterProgress) => total + chapterProgress.totalChapterScore,
//     0
//   );
// }
